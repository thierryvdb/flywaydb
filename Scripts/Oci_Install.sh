...
# Define pip trusted hosts
PIP_TRUSTED_HOSTS="--trusted-host pypi.org --trusted-host pypi.python.org --trusted-host files.pythonhosted.org"

# Add pip trusted hosts to install_args if not already included
install_args="$install_args $PIP_TRUSTED_HOSTS"

# Ensure pip uses trusted hosts for package installations
echo "Running install script with trusted hosts."
